...
import { Briefcase, Home, Info, LogOut, Menu, UserIcon, X } from "lucide-react"; // Use lucide icons like this
              ...
              <Popover>
                ...
                <PopoverContent className="w-56 p-2" align="end">
                  <div className="px-3 py-2 mb-2 border-b">
                    <p className="text-sm font-semibold">Biraj</p>
                    <p className="text-xs opacity-60 truncate "></p>
                  </div>
                  <Link href={"/account"}>
                    <Button
